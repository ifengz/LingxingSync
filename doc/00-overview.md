...
| 文档 | 内容 |
|---|---|
| [01-architecture.md](01-architecture.md) | 架构设计、Go 选型理由、Worker 核心循环、禁止事项 |
| [02-database.md](02-database.md) | 所有表 DDL（系统表 + 数据表）、polabel2 消费契约 |
| [03-config.md](03-config.md) | config.yaml 完整格式、所有字段说明 |
...
| [08-api-reference.md](08-api-reference.md) | 领星 OpenAPI 接入参考：认证、签名算法、接口清单、踩坑汇总 |
| [09-endpoint-contract.md](09-endpoint-contract.md) | 接入合同五格模板、产品表现完整示例、限流键规则、加接口速查清单 |
