...
var catalogEntries = []CatalogEntry{
	...
	},
	{
		...
		Summary:            "按 vendor profile_id 逐日补偿最近 7 天的 VC SP 商品广告日报（报表 T-2 起可用）。",
	...
	},
	{
		...
		Summary:            "按 vendor profile_id 逐日补偿最近 7 天的 VC SD 商品广告日报（报表 T-2 起可用）。",
	...
	},
	{
		...
		Summary:            "按 vendor profile_id 逐日补偿最近 7 天的 VC HSA/SB 商品广告日报；无 ASIN 时保留账号级归因。",
	...
	},
	{
		Key:                "ad_sp_product",
		Display:            "SP 商品广告报表",
		Summary:            "按有效广告账号逐日补偿最近 7 天的 SP 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/spProductAdReports",
		Method:             "POST",
	...
	},
	{
		Key:                "ad_sp_campaign",
		Display:            "SP 活动广告报表",
		Summary:            "按有效广告账号逐日补偿最近 7 天的 SP 活动广告日报（报表 T-2 起可用）。",
	...
	},
	{
		Key:                "ad_sd_product",
		Display:            "SD 商品广告报表",
		Summary:            "按有效广告账号逐日补偿最近 7 天的 SD 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/sdProductAdReports",
		Method:             "POST",
	...
	},
	{
		Key:                "ad_sd_campaign",
		Display:            "SD 活动广告报表",
		Summary:            "按有效 seller 广告账号逐日补偿最近 7 天的 SD 活动广告日报（报表 T-2 起可用）。",
	...
	},
	{
		Key:                "ad_hsa_campaign",
		Display:            "HSA 活动广告报表",
		Summary:            "按有效 seller 广告账号逐日补偿最近 7 天的 HSA 活动广告日报（报表 T-2 起可用）。",
