...
var catalogEntries = []CatalogEntry{
	...
	},
	{
		...
		Summary:          "按 SC 店铺逐日补偿最近 7 天的 ASIN 日销量（报表 T-2 起可用）。",
		...
		DateOffsetDays:   2,
		WindowStartField: "event_date",
		WindowEndField:   "event_date",
	...
	},
	{
		...
		Summary:          "按 SC 店铺逐日补偿最近 7 天的 ASIN 日销售额（报表 T-2 起可用）。",
		Path:             "/erp/sc/data/sales_report/asinDailyLists",
		Method:           "POST",
	...
	{
		Key:          "ad_accounts_vendor",
		Display:      "VC 广告账号",
		Summary:      "同步 vendor profile_id，供 VC SP/SD/HSA 广告日报使用。",
		Path:         "/basicOpen/baseData/account/list",
		Method:       "POST",
		Table:        "ls_ad_vendor_accounts",
		RecordIDs:    []string{"profile_id"},
		Rate:         Rate{Bucket: 10, IntervalMs: 1000, MultiIntervalMs: 0, Dimension: "account+path"},
		DefaultCron:  "0 5 * * *",
		ExtraParams:  map[string]any{"type": "vendor"},
		InjectParams: []string{"type"},
	},
	{
		Key:                "ad_vc_sp_product",
		Display:            "VC SP 商品广告报表",
		Summary:            "按 vendor profile_id 逐日补偿最近 60 天的 VC SP 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/spProductAdReports",
		Method:             "POST",
		Table:              "ls_ad_vc_sp_product",
		RecordIDs:          []string{"profile_id", "report_date", "ad_id"},
		Rate:               Rate{Bucket: 10, IntervalMs: 1000, MultiIntervalMs: 0, Dimension: "account+path"},
		DefaultCron:        "0 5 * * *",
		WindowDays:         60,
		SingleDayWindow:    true,
		...
		AdAccountType:      "vendor",
		ForceInjectParams:  []string{"profile_id"},
	},
	{
		Key:                "ad_vc_sd_product",
		Display:            "VC SD 商品广告报表",
		Summary:            "按 vendor profile_id 逐日补偿最近 60 天的 VC SD 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/sdProductAdReports",
		Method:             "POST",
		Table:              "ls_ad_vc_sd_product",
		RecordIDs:          []string{"profile_id", "report_date", "ad_id"},
		Rate:               Rate{Bucket: 10, IntervalMs: 1000, MultiIntervalMs: 0, Dimension: "account+path"},
		DefaultCron:        "0 5 * * *",
		WindowDays:         60,
	...
	{
		Key:                "ad_vc_hsa_product",
		Display:            "VC HSA/SB 商品广告报表",
		Summary:            "按 vendor profile_id 逐日补偿最近 60 天的 VC HSA/SB 商品广告日报；无 ASIN 时保留账号级归因。",
		Path:               "/pb/openapi/newad/listHsaProductAdReport",
		Method:             "POST",
		Table:              "ls_ad_vc_hsa_product",
		RecordIDs:          []string{"profile_id", "report_date", "ad_creative_id"},
		Rate:               Rate{Bucket: 10, IntervalMs: 1000, MultiIntervalMs: 0, Dimension: "account+path"},
		DefaultCron:        "0 5 * * *",
		WindowDays:         60,
		SingleDayWindow:    true,
	...
	},
	{
		Key:                "ad_sp_product",
		Display:            "SP 商品广告报表",
		Summary:            "按有效广告账号逐日补偿最近 60 天的 SP 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/spProductAdReports",
		Method:             "POST",
	...
	},
	{
		Key:                "ad_sp_campaign",
		Display:            "SP 活动广告报表",
		Summary:            "按有效广告账号逐日补偿最近 60 天的 SP 活动广告日报（报表 T-2 起可用）。",
	...
	},
	{
		Key:                "ad_sd_product",
		Display:            "SD 商品广告报表",
		Summary:            "按有效广告账号逐日补偿最近 60 天的 SD 商品广告日报（报表 T-2 起可用）。",
		Path:               "/pb/openapi/newad/sdProductAdReports",
		Method:             "POST",
	...
	},
	{
		Key:                "ad_sd_campaign",
		Display:            "SD 活动广告报表",
		Summary:            "按有效 seller 广告账号逐日补偿最近 60 天的 SD 活动广告日报（报表 T-2 起可用）。",
	...
	},
	{
		Key:                "ad_hsa_campaign",
		Display:            "HSA 活动广告报表",
		Summary:            "按有效 seller 广告账号逐日补偿最近 60 天的 HSA 活动广告日报（报表 T-2 起可用）。",
