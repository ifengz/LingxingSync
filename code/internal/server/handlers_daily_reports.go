...
func reportExportAPIType(value string) string {
	...
	case config.ReportExportFBAInventory:
		return reportexport.FBAInventoryReportType
	case config.ReportExportFBAAllInventory:
		return reportexport.FBAAllInventoryReportType
	...
	case config.ReportExportFBAInventoryPlanning:
		return reportexport.FBAInventoryPlanningReportType
	...
	case config.ReportExportFBARecommendedRemoval:
		return reportexport.FBARecommendedRemovalReportType
	case config.ReportExportFBARemovalOrder:
		return reportexport.FBARemovalOrderReportType
	case config.ReportExportFBARemovalShipment:
		return reportexport.FBARemovalShipmentReportType
	case config.ReportExportAllOrders:
		return reportexport.AllOrdersReportType
	case config.ReportExportFulfilledShipments:
		return reportexport.FulfilledShipmentsReportType
	default:
		return ""
	}
}
